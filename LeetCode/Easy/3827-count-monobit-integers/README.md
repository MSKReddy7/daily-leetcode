<h2><a href="https://leetcode.com/problems/count-monobit-integers/?envType=problem-list-v2&envId=bit-manipulation">3827. Count Monobit Integers</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>.</p>
