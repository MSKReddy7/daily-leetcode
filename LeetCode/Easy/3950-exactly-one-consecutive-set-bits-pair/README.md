<h2><a href="https://leetcode.com/problems/exactly-one-consecutive-set-bits-pair/?envType=problem-list-v2&envId=bit-manipulation">3950. Exactly One Consecutive Set Bits Pair</a></h2><h3>Easy</h3><hr><p>You are given an integer <code>n</code>.</p>
